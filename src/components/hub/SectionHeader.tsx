  ...
  return (
    <div className="flex items-center gap-4 mb-8 pb-5 border-b border-white/10">
      ...
      <div className="flex-1">
        <h2 className="font-display font-bold text-xl text-white leading-tight">{categoryLabel}</h2>
        <p className="text-sm text-[#6b7299] mt-1">{category.description}</p>
      </div>
      <div className={cn("font-display font-bold text-xs px-3 py-1 rounded-full text-white", category.color)}>
